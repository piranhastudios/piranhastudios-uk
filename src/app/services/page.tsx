...
const ServiceCard = ({ icon: Icon, title, description, items }: ServiceSectionProps) => (
  <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow">
    ...
    <ul className="space-y-4">
      {items.map((item, index) => (
        <li key={index} className="flex items-start gap-3">
          <FaCheckCircle className="w-5 h-5 mt-1 text-green-500 dark:text-green-400 flex-shrink-0" />
          {typeof item === 'object' ? (
            <div>
...
return (
    <Container>
      <div className="py-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <div className="mt-8">
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:ring-red-200 dark:focus:ring-red-800"
            >
        ...
        {/* CTA Section */}
        <div className="max-w-3xl mx-auto text-center bg-gray-50 dark:bg-gray-800 rounded-2xl p-12">
