        ...
        <div className="py-8 px-4">
            <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    {step === 4 && (
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold mb-4">📌 Get Your Free Digital Strategy Guide!</h2>
                            <div className="space-y-4 bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                                <h3 className="font-medium text-gray-800 dark:text-white">💡 As a thank-you, you&apos;ll
                                    receive:</h3>
