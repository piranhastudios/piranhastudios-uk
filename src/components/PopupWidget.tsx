...
export function PopupWidget() {
    ...
    const onSubmit = async (data: any, e: any) => {
        ...
        await fetch("https://hooks.zapier.com/hooks/catch/16082503/2mjtr7z/", {
            ...
            .then(async () => {
                setIsSuccess(true);
                setMessage("Thank you one of our specialists will contact you soon.");
                e.target.reset();
                reset();
            })
            .catch((error) => {
        ...
        <div>
            <Disclosure>
                {({open}) => (
                    <>
                        <DisclosureButton
                            className="fixed z-40 flex items-center justify-center transition duration-300 bg-red-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-red-600 focus:bg-red-600 ease">
                                ...
                                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                                    {!isSubmitSuccessful && (
                                        <form onSubmit={handleSubmit(onSubmit)} noValidate>
                                            <input
                                                type="hidden"
                                                value={`${userName} sent a message to piranha studios customer support`}
                                                {...register("subject")}
                                            />
                                            <input
                                                type="hidden"
