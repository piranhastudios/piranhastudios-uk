        ...
        <div className="relative">
            <Container>
                        ...
                        <div>
                            ...
                            >
                                <Image
                                    ...
                                    className="w-8"
                                />
                                <span className={"text-red-500 "}>Piranha</span> <span>Studios</span>
                            </Link>
                        </div>
                ...
                <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
                    ...
                    <a href="https://piranha-studios.co.uk/" target="_blank" rel="noopener">
                        Piranha Studios.
                    </a>{" "}
                    Illustrations from{" "}
                    <a href="https://lottiefiles.com/" target="_blank" rel="noopener ">
                        lottiefiles
                    </a>
                </div>
            </Container>
